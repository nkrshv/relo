  ...
  return (
    ...
    >
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(w,d,s,l,i){w[l]=w[l]||[];function load(){if(w.__gtmLoaded)return;w.__gtmLoaded=1;w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);}var ev=['scroll','keydown','pointerdown','touchstart'];function go(){ev.forEach(function(e){w.removeEventListener(e,go);});load();}ev.forEach(function(e){w.addEventListener(e,go,{passive:true,once:true});});if('requestIdleCallback' in w){w.requestIdleCallback(load,{timeout:5000});}else{setTimeout(load,4000);}})(window,document,'script','dataLayer','${GTM_ID}');`,
          }}
        />
      </head>
