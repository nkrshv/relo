...
- "departure" — NOTIFY TAX & SOCIAL SECURITY: notify the home tax authority of the move (exit formalities or a final return) and check any social-security/pension totalization agreement between the two countries so contributions and future pension rights are not lost.
