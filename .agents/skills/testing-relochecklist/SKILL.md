...
- Submitting shows a stepped loading list (5 checks ticking green ~every 2s; last step holds a spinner until the plan fades in). If you see a single cycling status line instead, the stepped loader may have regressed.
